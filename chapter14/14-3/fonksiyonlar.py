...
def eventleri_kontrol(ayarlar, ekran, istatistik, oyuna_başla,
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            oyna_butonu_kontrol(ayarlar, istatistik, oyuna_başla, mouse_x, mouse_y )

def oyna_butonu_kontrol(ayarlar, istatistik, oyuna_başla, mouse_x, mouse_y):
